        ...
        <div className="flex justify-center  mt-10 items-center w-full ">
          <div className="grid grid-cols-3 lg:grid-cols-6 gap-6 ">
            <a href={socialData.GitHub.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.GitHub.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
            ...
            <a href={socialData.Instagram.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.Instagram.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
            ...
            <a href={socialData.LinkedIn.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.LinkedIn.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
            ...
            <a href={socialData.Reddit.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.Reddit.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
            ...
            <a href={socialData.X.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.X.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
            <a href={socialData.email.url} target="_blank">
              <MagicCard className="w-full p-5 z-0 aspect-square ">
                <div className="flex  z-0 justify-center flex-col items-center gap-2">
                  <socialData.email.icon className="lg:w-10 w-4 h-4 lg:h-10" />
                </div>
              </MagicCard>
            </a>
          </div>
